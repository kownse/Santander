...
def compiled_leak_result():
    ...
    for i in range(max_nlags):
        ...
        train_leak[c] = _get_leak(train, cols2, [], i)
...
train_res.to_csv('../input/train_leak_clean.csv', index=False)
...
def compiled_leak_result_test(max_nlags):
    ...
    for i in range(max_nlags):
        ...
        print('Processing lag', i)
        test_leak[c] = _get_leak(test, cols2, [], i)
...
test_res.to_csv('../input/test_leak_clean.csv', index=False)
